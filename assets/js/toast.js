...
const successIcon = `<svg id="success-icon" style="color: #14b8a6;" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
...
const infoIcon = `<svg id="info-icon" style="color: #3b82f6;" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                fill="currentColor" viewBox="0 0 16 16">
                <path
...
const warningIcon = `<svg id="warning-icon" style="color: #eab308;" xmlns="http://www.w3.org/2000/svg" width="24"
...
const errorIcon = `<svg id="error-icon" style="color: #ef4444;" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                fill="currentColor" viewBox="0 0 16 16">
                <path
	...
	showToast(toast) {
		...
		if (this.toastQueue.length > 0) {
			for (let i = 0; i < this.toastQueue.length; i++) {
				const topPos = (93 * (this.toastQueue.length - i)) + 8
