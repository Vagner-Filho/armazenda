...
const successIcon = `<svg id="success-icon" class="shrink-0 size-6 text-teal-500 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
...
const infoIcon = `<svg id="info-icon" class="shrink-0 size-6 text-blue-500 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                fill="currentColor" viewBox="0 0 16 16">
                <path
...
const warningIcon = `<svg id="warning-icon" class="shrink-0 size-6 text-yellow-500 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24"
...
const errorIcon = `<svg id="error-icon" class="shrink-0 size-6 text-red-500 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                fill="currentColor" viewBox="0 0 16 16">
                <path
